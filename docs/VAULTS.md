...
- The current trading terminal is wired to the original demo pool. A deployed
  factory manifest is required before exposing vault creation and LP actions in
  the UI.
